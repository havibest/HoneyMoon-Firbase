...
import { AlertTriangle, CheckCircle, XCircle, Eye, Search, Flag } from "lucide-react";
...
export default function AdminReports() {
  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        <h1 className="font-['Playfair_Display'] text-3xl font-bold text-foreground">Reports</h1>
