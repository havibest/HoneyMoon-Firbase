...
import { Heart, MessageCircle, MapPin, RefreshCw, Search, Users } from "lucide-react";
...
export default function DiscoverPage() {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const data = await getDiscoverProfiles(user.uid, profile.interestedIn || "everyone", 40);
      setProfiles(data);
    } catch {
